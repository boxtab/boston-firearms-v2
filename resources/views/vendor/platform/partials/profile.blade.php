<div class="d-flex m-0 align-items-center p-3">
    <div class="dropdown w-75">
        ...
        <div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow bg-white">
            ...
            <a href="#" class="dropdown-item" data-controller="form" data-action="form#submitByForm" data-form-id="return-original-user">
                <x-orchid-icon path="people" class="me-2" />
                <span>{{ __('Back to my account') }}</span>
            </a>
            <form id="return-original-user" class="hidden" data-controller="form" data-action="form#submit" action="{{ route('platform.switch.logout') }}" method="POST">
                @csrf
            </form>
            @endif
