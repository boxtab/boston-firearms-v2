...
<body>
    <div class="page page-39">
                ...
                <div class="steps">
                    <div class="step">
                        ...
                        <div class="step-content">
                            Take our State Police Certified Firearms Safety Course required by Massachusetts law.
                        </div>
                        <div class="step-divider"></div>
                    </div>
                    <div class="step">
                        <div class="step-title "> STEP 02 </div>
                        <div class="step-content"> We award you a certificate of completion the same day stamped with Live Fire training </div>
                        <div class="step-divider"></div>
                    </div>

                    <div class="step">
                        <div class="step-title "> STEP 03 </div>
                        <div class="step-content"> We help you apply for your license at your local police station to make sure you have the best chance of getting approved. </div>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="desktop-wide-wrap">
                <div class="info-section">
                    <div class="info-block price">
                        <div> 6 state licenses all in one course </div>
                        <div class="cost"> $300 </div>
                    </div>
                </div>
                <div class="button-row"> <a class="button" href="#"> See Schedule </a> </div>
            </div>
        </div>
        <!-- Info End -->
        ...
        <div class="map-section">
            <div class="desktop-wide-wrap">
                <div class="heading-section">
                    <div class="title"> <strong class=""> What States Can I Carry In </strong> </div>
                </div>
        ...
        <div class="bg-image">
            <div class="desktop-wide-wrap">
                ...
                <div class="list-section">
                    <div class="list-section-title"> Who Is This Class For? </div>
                    <div class="list">
                        <div class="list-item"> It does not matter if you are a Massachusetts resident </div>
                        <div class="list-item"> You are 21+ years or older. </div>
                        <div class="list-item"> You want to carry legally in up to 39 states. </div>
                    </div>
                </div> <!-- List End -->
            </div> <!-- BG image End -->
        </div> <!-- BG image End -->
        ...
        <!-- Not Sure Start -->
        <div class="not-sure-section">
            <div class="heading-section">
                <div class="title"> <strong class=""> Not Sure If You Qualify? </strong> </div>
                <div class="subtitle"> Take this quiz to find out </div>
                <div class="button-row"> <a class="button" href="#"> Start Quiz </a> </div>
            </div>
        </div> <!-- Not Sure End -->
        ...
        <div class="bg-image bg-image--cta">
            <div class="desktop-wide-wrap">
                <div class="call-to-action-section">
                    ...
                    <div class="heading-section">
                        <div class="title"> <strong class=""> What Can I Expect In The Class? </strong> </div>
                    </div>

                    <div class="cta-list">
                        <div class="cta-item">
                            <div class="ico"> <img src="/images/page-39/ico-clock.svg" alt=""> </div>
                            <h5>Length = 4 hours or less </h5>
                        </div>
                        <div class="cta-item">
                            <div class="ico"> <img src="/images/page-39/ico-live.svg" alt=""> </div>
                            <h5> Live Fire Shooting in our indoor range </h5>
                        </div>
                        <div class="cta-item">
                            <div class="ico"> <img src="/images/page-39/ico-map.svg" alt=""> </div>
                            <h5> Leave with the ability to apply in all <br> 6 states allowing 39 state reciprocity. </h5>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="how-much-section">
            <div class="heading-section">
                <div class="title"> <strong class=""> How much does it cost? </strong> </div>
            </div>
            <div class="info-section">
                <div class="info-block price">
                    <div class="cost"> $300 </div>
                ...
                <div class="info-block description">
                    <div class="">
                        <p> The goal of this course is to combine everything you need to know to qualify for all 6 state licenses in one class. MA, UT, FL, ME, NH, CT. </p>
                        <p> By taking this course you save $400 or more. If you were to take each state course separately it would cost you upwards of $700+ </p>
                    </div>
                </div>
            </div>
        ...
        <div class="faq-section--responsive">
            <div class="desktop-wide-wrap">
                <div class="faq-section">
                    ...
                    <div class="faq-list">
                        <div class="faq">
                            <div class="title"> What if I already have my Massachusetts LTC? <br>
                            </div>
                        ...
                        <div class="faq">
                            <div class="title"> Do I need to take the Massachusetts course first? <br>
                            </div>
                        ...
                        <div class="faq">
                            <div class="title"> What are the 39 states I can carry in? <br>
                            </div>
                        ...
                        <div class="faq">
                            <div class="title"> What about constitutional carry states? <br>
                            </div>
                        ...
                        <div class="faq">
                            <div class="title"> Does my city allow me to get a license? <br>
                            </div>
                        ...
                        <div class="faq">
                            <div class="title"> Do I need to own a firearm to attend class? <br>
                            </div>
                        ...
                        <div class="faq">
                            <div class="title"> How many times do I need to take the class? <br>
                            </div>
            ...
            <div class="footer-39">
                <div class="desktop-wide-wrap">
                    <p> <a href="/quiz/privacy-policy">Privacy Policy</a> <a href="/quiz/terms-and-condition">Terms &amp; Conditions</a> </p>
